...
/* --- STATE_DATA -----------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
const STATE_DATA = {
  AL:{name:"Alabama",voterTurnout:61.5,uninsured:8.2,lifeExp:73.8},
  AK:{name:"Alaska",voterTurnout:68.2,uninsured:11.1,lifeExp:75.8},
  AZ:{name:"Arizona",voterTurnout:66.6,uninsured:10.2,lifeExp:76.7},
  AR:{name:"Arkansas",voterTurnout:56.2,uninsured:9.3,lifeExp:73.9},
  CA:{name:"California",voterTurnout:68.8,uninsured:5.9,lifeExp:79.3},
  CO:{name:"Colorado",voterTurnout:76.7,uninsured:7.8,lifeExp:78.5},
  CT:{name:"Connecticut",voterTurnout:70.1,uninsured:5.7,lifeExp:79.4},
  DE:{name:"Delaware",voterTurnout:68.3,uninsured:6.9,lifeExp:76.5},
  DC:{name:"D.C.",voterTurnout:68.9,uninsured:4.7,lifeExp:76.6},
  FL:{name:"Florida",voterTurnout:70.8,uninsured:10.9,lifeExp:77.9},
  GA:{name:"Georgia",voterTurnout:67.1,uninsured:12.0,lifeExp:75.9},
  HI:{name:"Hawaii",voterTurnout:55.4,uninsured:3.3,lifeExp:80.0},
  ID:{name:"Idaho",voterTurnout:64.9,uninsured:9.0,lifeExp:78.4},
  IL:{name:"Illinois",voterTurnout:66.5,uninsured:6.8,lifeExp:77.5},
  IN:{name:"Indiana",voterTurnout:61.1,uninsured:7.4,lifeExp:75.4},
  IA:{name:"Iowa",voterTurnout:72.0,uninsured:5.7,lifeExp:77.9},
  KS:{name:"Kansas",voterTurnout:65.1,uninsured:8.6,lifeExp:76.5},
  KY:{name:"Kentucky",voterTurnout:64.4,uninsured:6.9,lifeExp:73.6},
  LA:{name:"Louisiana",voterTurnout:64.1,uninsured:7.6,lifeExp:73.8},
  ME:{name:"Maine",voterTurnout:74.9,uninsured:5.6,lifeExp:76.6},
  MD:{name:"Maryland",voterTurnout:69.5,uninsured:6.2,lifeExp:77.8},
  MA:{name:"Massachusetts",voterTurnout:71.3,uninsured:2.8,lifeExp:79.8},
  MI:{name:"Michigan",voterTurnout:73.3,uninsured:5.0,lifeExp:76.8},
  MN:{name:"Minnesota",voterTurnout:79.2,uninsured:5.3,lifeExp:79.3},
  MS:{name:"Mississippi",voterTurnout:60.6,uninsured:9.7,lifeExp:72.6},
  MO:{name:"Missouri",voterTurnout:65.5,uninsured:7.6,lifeExp:75.2},
  MT:{name:"Montana",voterTurnout:71.3,uninsured:8.6,lifeExp:77.3},
  NE:{name:"Nebraska",voterTurnout:69.1,uninsured:7.6,lifeExp:78.3},
  NV:{name:"Nevada",voterTurnout:64.3,uninsured:11.4,lifeExp:76.4},
  NH:{name:"New Hampshire",voterTurnout:74.0,uninsured:4.7,lifeExp:78.7},
  NJ:{name:"New Jersey",voterTurnout:72.0,uninsured:7.7,lifeExp:79.6},
  NM:{name:"New Mexico",voterTurnout:60.5,uninsured:10.2,lifeExp:74.5},
  NY:{name:"New York",voterTurnout:61.7,uninsured:4.9,lifeExp:79.5},
  NC:{name:"North Carolina",voterTurnout:71.0,uninsured:8.6,lifeExp:75.9},
  ND:{name:"North Dakota",voterTurnout:63.1,uninsured:6.0,lifeExp:77.9},
  OH:{name:"Ohio",voterTurnout:67.1,uninsured:6.7,lifeExp:75.6},
  OK:{name:"Oklahoma",voterTurnout:54.4,uninsured:11.7,lifeExp:73.8},
  OR:{name:"Oregon",voterTurnout:75.3,uninsured:5.2,lifeExp:77.7},
  PA:{name:"Pennsylvania",voterTurnout:69.9,uninsured:6.0,lifeExp:77.3},
  RI:{name:"Rhode Island",voterTurnout:63.1,uninsured:4.8,lifeExp:79.2},
  SC:{name:"South Carolina",voterTurnout:64.7,uninsured:9.1,lifeExp:75.1},
  SD:{name:"South Dakota",voterTurnout:65.6,uninsured:7.9,lifeExp:77.3},
  TN:{name:"Tennessee",voterTurnout:59.2,uninsured:9.7,lifeExp:73.8},
  TX:{name:"Texas",voterTurnout:59.8,uninsured:16.8,lifeExp:77.1},
  UT:{name:"Utah",voterTurnout:67.2,uninsured:8.3,lifeExp:79.0},
  VT:{name:"Vermont",voterTurnout:71.3,uninsured:4.3,lifeExp:78.3},
  VA:{name:"Virginia",voterTurnout:71.8,uninsured:6.8,lifeExp:77.5},
  WA:{name:"Washington",voterTurnout:75.3,uninsured:6.5,lifeExp:78.4},
  WV:{name:"W. Virginia",voterTurnout:57.2,uninsured:5.9,lifeExp:72.2},
  WI:{name:"Wisconsin",voterTurnout:75.0,uninsured:5.4,lifeExp:78.1},
  WY:{name:"Wyoming",voterTurnout:64.7,uninsured:9.7,lifeExp:76.8},
};
...
const CD_PATHS = {
  ...
  "BX02":{p:"M69.4,26.8L69.5,26.8L70.8,26.5L71.9,26.6L72.6,27.5L73.5,27.3L74.3,27.4L74.8,27.7L75.1,27.5L75.7,26.5L75.1,25L73.9,24.5L73,23.8L72.8,23.2L72.7,22.6L72.9,22L72.5,22.1L72.1,22.3L71.2,22.3L70.3,21.7L69.6,23.6L69,25.3L69.2,25.5L69.4,26.8Z",cx:71.7,cy:25.6},
  ...
  "MN01":{p:"M48.5,43L49.1,43.2L48.8,44.7L48.2,44.7L48,45.7L47.7,47.3L47.9,47.7L48.5,48.4L49.2,48.3L50.7,47.4L50.9,47.6L51.2,47.4L51.1,47.1L51.4,46.9L51,46.5L51.2,46.3L51.2,45.3L51.4,44.9L49.2,43.1L48.5,43Z",cx:48.2,cy:48.1},
  ...
  "MN08":{p:"M61.8,31.4L59.5,30.3L56.3,35.2L57.2,35.7L58.9,36.5L59.8,35.7L60.9,34.2L61.9,33.1L62.1,32.8L61.8,31.9L61.8,31.4Z",cx:60.6,cy:34.3},
  ...
  "MN11":{p:"M61.8,31.4L62.5,30.9L62.8,30.5L63.2,29.7L64.2,29L64.5,28.5L64.5,27.6L64.1,26.8L63.6,26.3L63.5,25.9L63.6,24L63.4,24.4L61.9,26.6L61.6,26.5L61.3,27L61.6,27.2L60.7,28.5L59.5,30.3L61.8,31.4Z",cx:64,cy:28.9},
  ...
  "QN14":{p:"M68.2,78.4L68.1,77.4L67.9,76.7L68,76.5L67.6,76.5L66.6,77L66.1,77.1L65.4,77.1L65,77.3L63.7,77.6L64.1,78.1L64.6,79.3L67.5,78.5L68.2,78.4Z",cx:66,cy:78},
...
/* ═══════════════════════════════════════════════════════════════════════════
   PULSE DOT
   ═══════════════════════════════════════════════════════════════════════════ */
function Pulse({cx,cy,r=6,color=RED}){
  return(<g>
  ...
  return(
    <div style={{
      ...
      <div style={{...panelCard, margin:"18px 18px 0", flexShrink:0}}>
        ...
        <p style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:13,lineHeight:1.75,color:"#374151",marginBottom:14}}>{ch.body}</p>
      ...
      {level===0&&(
        <div style={{...panelCard, margin:"14px 18px 0", flexShrink:0}}>
          ...
          {[["#dc2626","< 58%","Low"],["#eab308","58–63%","Below avg."],["#65a30d","64–69%","Average"],["#15803d","70%+","High"]].map(([c,l,s])=>(
            <div key={l} style={{display:"flex",alignItems:"center",gap:10,marginBottom:9}}>
              <div style={{width:16,height:16,background:c,borderRadius:3,flexShrink:0}}/>
              <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:14,fontWeight:500,color:"#1a1a1a"}}>{l}</span>
              <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:"#9ca3af"}}>{s}</span>
            </div>
          ))}
          <div style={{marginTop:12,paddingTop:10,borderTop:"1px solid #e5e1d8"}}>
            <p style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:9,color:"#9ca3af",lineHeight:1.9}}>
              <a href="https://election.lab.ufl.edu/voter-turnout/2020-general-election-turnout/" target="_blank" style={{color:"#518ef6",display:"block"}}>Voter Turnout -- UF Election Lab, 2020 VEP</a>
              <a href="https://www.kff.org/state-health-policy-data/state-indicator/total-population/" target="_blank" style={{color:"#518ef6",display:"block"}}>Uninsured Rate -- KFF ACS, 2022-2023</a>
              <a href="https://www.cdc.gov/nchs/data/nvsr/nvsr74/nvsr74-12.pdf" target="_blank" style={{color:"#518ef6",display:"block"}}>Life Expectancy -- CDC NVSR Vol. 74 No. 12, 2022</a>
            </p>
          </div>
        </div>
      )}
      ...
      {level===0&&hovStateData&&(
        <div style={{...panelCard,margin:"14px 18px 0",flexShrink:0,animation:"fadeIn 0.15s ease-out"}}>
          ...
          {[["Voter Turnout",`${hovStateData.voterTurnout}%`,hovStateData.voterTurnout,RED],["Uninsured",`${hovStateData.uninsured}%`,hovStateData.uninsured*5,"#7c3aed"],["Life Expectancy",`${hovStateData.lifeExp} yrs`,(hovStateData.lifeExp-70)*10,"#0891b2"]].map(([l,v,bar,c])=>(
            <div key={l} style={{marginBottom:12}}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:"#6b7280"}}>{l}</span>
                <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:13,fontWeight:700,color:"#1a1a1a"}}>{v}</span>
              </div>
              <div style={{height:4,background:"#f0ede6",borderRadius:2,overflow:"hidden"}}>
                <div style={{height:"100%",width:`${Math.min(100,bar)}%`,background:c,borderRadius:2,transition:"width 0.4s"}}/>
              </div>
            </div>
          ))}
        </div>
      ...
      {level===1&&(
        <div style={{...panelCard,margin:"14px 18px 0",flexShrink:0}}>
          ...
          <div style={{display:"flex",gap:0,marginBottom:14}}>
            <div style={{flex:1,borderRight:"1px solid #e5e1d8",paddingRight:12}}>
              <div style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:30,fontWeight:900,color:"#15803d",lineHeight:1}}>{best.le}</div>
              <div style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:"#6b7280",marginTop:4,lineHeight:1.3}}>{best.name}</div>
              <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:9,color:"#9ca3af",marginTop:2}}>{best.borough}</div>
            </div>
            <div style={{flex:1,paddingLeft:12}}>
              <div style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:30,fontWeight:900,color:RED,lineHeight:1}}>{worst.le}</div>
              <div style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:"#6b7280",marginTop:4,lineHeight:1.3}}>{worst.name}</div>
              <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:9,color:"#9ca3af",marginTop:2}}>{worst.borough}</div>
            </div>
          </div>
          <div style={{background:"#f5f3ef",padding:"8px 10px",marginBottom:12}}>
            <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:"#374151"}}>Gap: </span>
            <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:13,fontWeight:900,color:RED}}>{(best.le-worst.le).toFixed(1)} years</span>
          </div>
          <p style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:12,fontWeight:700,color:"#1a1a1a",marginBottom:10,textTransform:"uppercase",letterSpacing:0.5}}>Life Expectancy</p>
          {[["#dc2626","< 79 yrs"],["#eab308","79–81 yrs"],["#65a30d","82–85 yrs"],["#15803d","86+ yrs"]].map(([c,l])=>(
            <div key={l} style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}>
              ...
              <span style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:13,fontWeight:500,color:"#1a1a1a"}}>{l}</span>
            </div>
          ))}
      ...
      {level===1&&hovHoodData&&(
        <div style={{...panelCard,margin:"14px 18px 0",flexShrink:0,animation:"fadeIn 0.15s ease-out"}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
            <div style={{width:12,height:12,borderRadius:"50%",background:leColor(hovHoodData.le),flexShrink:0}}/>
      ...
      <div style={{
        ...
        display:"flex",
        justifyContent: level===0 ? "flex-end" : "space-between",
        alignItems:"center",
        flexShrink:0,
        background:CREAM,
      }}>
  ...
  return(
    <svg viewBox="0 0 760 480" style={{width:"100%",height:"100%"}}>
      ...
      {(()=>{const[c,r]=HEX_GRID.NY;const cx=oX+c*pX+(r%2===1?pX/2:0),cy=oY+r*pY;return(
        <polygon points={hex(cx,cy)} fill="none" stroke={RED} strokeWidth={2.5} opacity={0.6} style={{pointerEvents:"none"}}>
      ...
      <div style={{position:"relative",paddingLeft:18}}>
        ...
        {person.timeline.map((t,i)=>{const tc=typeColor[t.type];return(
          <div key={i} style={{position:"relative",marginBottom:20,paddingLeft:18,animation:`fadeIn 0.35s ease-out ${i*0.05}s both`}}>
            ...
            <div style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:15,fontWeight:700,color:"#1a1a1a",marginBottom:3}}>{t.title}</div>
...
export default function App(){
  ...
  return(
    <div style={{width:"100vw",height:"100vh",overflow:"hidden",background:CREAM,position:"relative",touchAction:"manipulation"}} onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
      ...
      {/* ── TITLE PAGE ── */}
      {level===-1&&(
        <div style={{...anim,position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:24,background:`linear-gradient(180deg,${CREAM},#ede9e0)`}}>
          <div style={{width:480,maxWidth:"90vw",display:"flex",flexDirection:"column",alignItems:"center"}}>
            <p style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:12,fontWeight:400,color:"#000",letterSpacing:3,textTransform:"uppercase",marginBottom:18}}>A Visual Investigation</p>
            <h1 style={{fontFamily:"'Libre Franklin',sans-serif",fontWeight:900,lineHeight:"80px",color:RED,fontSize:74,marginBottom:0}}>Civic Health</h1>
            <h1 style={{fontFamily:"'Libre Franklin',sans-serif",fontWeight:900,lineHeight:"63px",color:RED,fontSize:74,marginBottom:24}}>Alliance</h1>
            <p style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:20,fontWeight:400,lineHeight:"27px",color:"#000",marginBottom:16,maxWidth:400}}>How voter turnout, community organizing, and public testimony shape the healthcare communities receive.</p>
            <p style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:20,fontWeight:400,color:"#000",marginBottom:40}}>From nation to neighborhood to hospital to a single human life.</p>
            <button
              onClick={()=>zoomTo(0)}
              style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:29,fontWeight:900,letterSpacing:"0.87px",padding:"14px 52px",background:"#1a1a1a",border:`2px solid ${RED}`,color:"#fff",cursor:"pointer",transition:"background 0.2s"}}
      ...
      {level>=0&&level<=2&&(
        <div style={{...anim,position:"absolute",inset:0,paddingTop:61,display:"flex"}}>
          <LeftPanel
            ...
            hovState={hovState}
            hovHood={hovHood}
            onPrev={()=>zoomTo(level-1,null)}
            onNext={()=>zoomTo(level+1,null)}
          />
